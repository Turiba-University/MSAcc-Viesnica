Operation =1
Option =0
Where ="(((dbo_viesn_Maksajumi.Last_Dat)>=[forms]![VIA_VietuSkaitsUzdatumu]![DatNo] And "
    "(dbo_viesn_Maksajumi.Last_Dat)<=[forms]![VIA_VietuSkaitsUzdatumu]![DatLidz]))"
Begin InputTables
    Name ="dbo_Personas"
...
Begin OutputColumns
    ...
    Alias ="TTips"
    Expression ="IIf([Position]=\"BAT students\",\"BATStud\",IIf([Position]=\"Cita skola\",\"Cita"
        "Skola\",IIf([Position]=\"Darbinieks\",\"Darbinieks\",IIf([Position]=\"Viesis\",\""
        "Viesis\",\"Cits\"))))"
    Alias ="ITips"
    Expression ="IIf([dbo_viesn_Ligumi_Istabas].[Istaba]<0,1,IIf([dbo_viesn_Ligumi_Istabas].[Ista"
        "ba]<199,2,3))"
    Alias ="Ist_Nr"
