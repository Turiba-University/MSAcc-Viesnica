...
FROM
  (
    (
      ...
      LEFT JOIN Rezervisti_24 ON dbo_viesn_kl_Istabas.Istaba = Rezervisti_24.Istaba
    )
    LEFT JOIN qryBrivasVietasAiznVSk_24 ON dbo_viesn_kl_Istabas.Istaba = qryBrivasVietasAiznVSk_24.Istaba
  )
  LEFT JOIN dbo_Personas ON Rezervisti_24.CKods = dbo_Personas.Personas_ID
GROUP BY
  dbo_viesn_kl_Istabas.Istaba,
  dbo_viesn_kl_Istabas.IstabasNr,
