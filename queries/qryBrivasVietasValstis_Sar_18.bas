...
Begin InputTables
    ...
    Name ="Rezervisti_18"
    Name ="qryBrivasVietasAiznVSk_18"
    Name ="dbo_Personas"
End
Begin OutputColumns
...
Begin Joins
    ...
    RightTable ="Rezervisti_18"
    Expression ="dbo_viesn_kl_Istabas.[Istaba] = Rezervisti_18.[Istaba]"
    Flag =2
    LeftTable ="dbo_viesn_kl_Istabas"
    RightTable ="qryBrivasVietasAiznVSk_18"
    Expression ="dbo_viesn_kl_Istabas.[Istaba] = qryBrivasVietasAiznVSk_18.[Istaba]"
    Flag =2
    LeftTable ="Rezervisti_18"
    RightTable ="dbo_Personas"
    Expression ="Rezervisti_18.[CKods] = dbo_Personas.[Personas_ID]"
    Flag =2
End
Begin OrderBy
    Expression ="dbo_viesn_kl_Istabas.IstabasNr"
