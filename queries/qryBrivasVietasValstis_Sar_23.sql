...
FROM
  (
    (
      ...
      LEFT JOIN Rezervisti_23 ON dbo_viesn_kl_Istabas.Istaba = Rezervisti_23.Istaba
    )
    LEFT JOIN qryBrivasVietasAiznVSk_23 ON dbo_viesn_kl_Istabas.Istaba = qryBrivasVietasAiznVSk_23.Istaba
  )
  LEFT JOIN dbo_Personas ON Rezervisti_23.CKods = dbo_Personas.Personas_ID
GROUP BY
  dbo_viesn_kl_Istabas.Istaba,
  dbo_viesn_kl_Istabas.IstabasNr,
