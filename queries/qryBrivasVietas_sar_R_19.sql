SELECT
  ...
  [dbo_viesn_kl_Istabas].[vietusk] -(
    ...
    where
      dbo_Viesn_Rezervesana.Rez_MG = 2019
...
FROM
  (
    ...
    LEFT JOIN (
      Rezervisti_19
      LEFT JOIN dbo_Personas ON Rezervisti_19.[CKods] = dbo_Personas.[Personas_ID]
    ) ON dbo_viesn_kl_Istabas.[Istaba] = Rezervisti_19.[Istaba]
  )
  LEFT JOIN VIA_StudStatData ON Rezervisti_19.CKods = VIA_StudStatData.CKods
GROUP BY
  dbo_viesn_kl_Istabas.Istaba,
  dbo_viesn_kl_Istabas.IstabasNr,
  dbo_viesn_kl_Istabas.VietuSk,
