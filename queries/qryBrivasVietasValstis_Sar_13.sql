...
FROM
  (
    (
      ...
      LEFT JOIN Rezervisti_13 ON dbo_viesn_kl_Istabas.Istaba = Rezervisti_13.Istaba
    )
    LEFT JOIN qryBrivasVietasAiznVSk_13 ON dbo_viesn_kl_Istabas.Istaba = qryBrivasVietasAiznVSk_13.Istaba
  )
  LEFT JOIN dbo_Personas ON Rezervisti_13.CKods = dbo_Personas.Personas_ID
GROUP BY
  dbo_viesn_kl_Istabas.Istaba,
