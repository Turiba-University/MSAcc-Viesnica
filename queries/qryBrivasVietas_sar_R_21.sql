SELECT
  ...
  [dbo_viesn_kl_Istabas].[vietusk] -(
    ...
    where
      dbo_Viesn_Rezervesana.Rez_MG = 2021
...
FROM
  (
    ...
    LEFT JOIN (
      Rezervisti_21
      LEFT JOIN dbo_Personas ON Rezervisti_21.CKods = dbo_Personas.Personas_ID
    ) ON dbo_viesn_kl_Istabas.Istaba = Rezervisti_21.Istaba
  )
  LEFT JOIN VIA_StudStatData ON Rezervisti_21.CKods = VIA_StudStatData.CKods
GROUP BY
  dbo_viesn_kl_Istabas.Istaba,
  dbo_viesn_kl_Istabas.IstabasNr,
  dbo_viesn_kl_Istabas.VietuSk,
