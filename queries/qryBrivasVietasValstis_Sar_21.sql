...
FROM
  (
    (
      ...
      LEFT JOIN Rezervisti_21 ON dbo_viesn_kl_Istabas.Istaba = Rezervisti_21.Istaba
    )
    LEFT JOIN qryBrivasVietasAiznVSk_21 ON dbo_viesn_kl_Istabas.Istaba = qryBrivasVietasAiznVSk_21.Istaba
  )
