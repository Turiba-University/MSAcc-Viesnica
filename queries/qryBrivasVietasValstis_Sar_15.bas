...
Begin InputTables
    ...
    Name ="Rezervisti_15"
    Name ="qryBrivasVietasAiznVSk_15"
    Name ="dbo_Personas"
End
Begin OutputColumns
...
Begin Joins
    ...
    RightTable ="Rezervisti_15"
    Expression ="dbo_viesn_kl_Istabas.Istaba = Rezervisti_15.Istaba"
    Flag =2
    LeftTable ="dbo_viesn_kl_Istabas"
    RightTable ="qryBrivasVietasAiznVSk_15"
    Expression ="dbo_viesn_kl_Istabas.Istaba = qryBrivasVietasAiznVSk_15.Istaba"
    Flag =2
    LeftTable ="Rezervisti_15"
    RightTable ="dbo_Personas"
    Expression ="Rezervisti_15.CKods = dbo_Personas.Personas_ID"
    Flag =2
End
Begin OrderBy
    Expression ="dbo_viesn_kl_Istabas.IstabasNr"
