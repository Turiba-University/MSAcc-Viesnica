...
Begin InputTables
    ...
    Name ="Rezervisti_13"
    Name ="qryBrivasVietasAiznVSk_13"
    Name ="dbo_Personas"
End
Begin OutputColumns
...
Begin Joins
    ...
    RightTable ="Rezervisti_13"
    Expression ="dbo_viesn_kl_Istabas.Istaba = Rezervisti_13.Istaba"
    Flag =2
    LeftTable ="dbo_viesn_kl_Istabas"
    RightTable ="qryBrivasVietasAiznVSk_13"
    Expression ="dbo_viesn_kl_Istabas.Istaba = qryBrivasVietasAiznVSk_13.Istaba"
    Flag =2
    LeftTable ="Rezervisti_13"
    RightTable ="dbo_Personas"
    Expression ="Rezervisti_13.CKods = dbo_Personas.Personas_ID"
    Flag =2
End
Begin OrderBy
    Expression ="dbo_viesn_kl_Istabas.Istaba"
