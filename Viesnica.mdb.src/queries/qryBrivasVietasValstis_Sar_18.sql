...
FROM
  (
    (
      ...
      LEFT JOIN Rezervisti_18 ON dbo_viesn_kl_Istabas.[Istaba] = Rezervisti_18.[Istaba]
    )
    LEFT JOIN qryBrivasVietasAiznVSk_18 ON dbo_viesn_kl_Istabas.[Istaba] = qryBrivasVietasAiznVSk_18.[Istaba]
  )
  LEFT JOIN dbo_Personas ON Rezervisti_18.[CKods] = dbo_Personas.[Personas_ID]
GROUP BY
  dbo_viesn_kl_Istabas.Istaba,
  dbo_viesn_kl_Istabas.IstabasNr,
