...
FROM
  (
    (
      ...
      LEFT JOIN Rezervisti_22 ON dbo_viesn_kl_Istabas.Istaba = Rezervisti_22.Istaba
    )
    LEFT JOIN qryBrivasVietasAiznVSk_22 ON dbo_viesn_kl_Istabas.Istaba = qryBrivasVietasAiznVSk_22.Istaba
  )
