...
Begin OutputColumns
    ...
    Expression ="[dbo_viesn_kl_Istabas].[vietusk]-(select Count([dbo_Viesn_Rezervesana].[Istaba])"
        ...
        "Rezervesana].[Istaba]=dbo_viesn_kl_Istabas.istaba;)"
    Alias ="S"
...
End
Begin Joins
    LeftTable ="qryBrivasVietasRez_R"
    RightTable ="dbo_viesn_kl_Istabas"
    Expression ="[qryBrivasVietasRez_R].[Istaba]=[dbo_viesn_kl_Istabas].[Istaba]"
    Flag =3
    LeftTable ="qryBrivasVietasRez_R"
    RightTable ="dbo_Personas"
    Expression ="[qryBrivasVietasRez_R].[CKods]=[dbo_Personas].[Personas_ID]"
    Flag =2
End
Begin OrderBy
    Expression ="[dbo_viesn_kl_Istabas].[Istaba]"
