...
Begin OutputColumns
    ...
    Alias ="UztDok"
    Expression ="IIf([CertVeids]=11,\"vīza\",IIf([CertVeids]=12,\"TUA\",IIf([CertVeids]=0,\"nav\""
        ",Null)))"
    Alias ="UztTermins"
    Expression ="VIA_PersUztDok.CertDatums"
...
dbMemo "Filter" ="([VIA_LigIstStat_All_LigReg_UzDat].[Statuss]<>\"BAT students\" Or [VIA_LigIstSta"
    "t_All_LigReg_UzDat].[Statuss] IS Null)"
Begin
    Begin
        dbText "Name" ="Sum"
