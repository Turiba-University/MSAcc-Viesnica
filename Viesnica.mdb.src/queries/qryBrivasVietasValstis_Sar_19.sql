...
FROM
  (
    (
      ...
      LEFT JOIN Rezervisti_19 ON dbo_viesn_kl_Istabas.[Istaba] = Rezervisti_19.[Istaba]
    )
    LEFT JOIN qryBrivasVietasAiznVSk_19 ON dbo_viesn_kl_Istabas.[Istaba] = qryBrivasVietasAiznVSk_19.[Istaba]
  )
