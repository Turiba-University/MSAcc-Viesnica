...
FROM
  (
    (
      ...
      LEFT JOIN Rezervisti_15 ON dbo_viesn_kl_Istabas.Istaba = Rezervisti_15.Istaba
    )
    LEFT JOIN qryBrivasVietasAiznVSk_15 ON dbo_viesn_kl_Istabas.Istaba = qryBrivasVietasAiznVSk_15.Istaba
  )
  LEFT JOIN dbo_Personas ON Rezervisti_15.CKods = dbo_Personas.Personas_ID
GROUP BY
  dbo_viesn_kl_Istabas.Istaba,
  dbo_viesn_kl_Istabas.IstabasNr,
