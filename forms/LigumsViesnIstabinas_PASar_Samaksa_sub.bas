...
Begin Form
    ...
    RecordSource ="SELECT dbo_viesn_Ligumi_PApr_Maksajumi.VLPAM_ID, dbo_viesn_Ligumi_PApr_Maksajumi"
        ...
        "mi.SamSum, dbo_viesn_Ligumi_PApr_Maksajumi.Fabula, dbo_viesn_Ligumi_PApr_Maksaju"
        "mi.MaksVeids, dbo_viesn_Ligumi_PApr_Maksajumi.MaksDat, dbo_viesn_Ligumi_PApr_Mak"
        "sajumi.PA_SamaksataSum, dbo_viesn_Ligumi_PApr_Maksajumi.Stat FROM dbo_viesn_Ligu"
        "mi_PApr_Maksajumi WHERE (((dbo_viesn_Ligumi_PApr_Maksajumi.Stat) Is Null Or Not "
        "(dbo_viesn_Ligumi_PApr_Maksajumi.Stat)=-1)) ORDER BY dbo_viesn_Ligumi_PApr_Maksa"
        "jumi.Dat_No DESC , dbo_viesn_Ligumi_PApr_Maksajumi.PA_Nos;"
    Caption ="MAKSAJUMI"
...
End
CodeBehindForm
' See "LigumsViesnIstabinas_PASar_Samaksa_sub.cls"
