        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    BackColor =33023
                    Name ="PE_Konvertets"
                    ControlSource ="=\"Ls līguma apskate\""
                End
            End
        End
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    TabIndex =12
                    Name ="MAKSAJUMIbeta"
                    SourceObject ="Form.PE_LigumsViesnMaksajumi_sub"
                ...
                Begin TextBox
                    ...
                    Begin
                        Begin Label
                            ...
                            Height =600
                            Name ="Label112"
                            Caption ="JP līgumiem pilnvarotā persona:"
                        End
                    End
                End
                Begin TextBox
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT dbo_stop.CKods, Sum(IIf(([Aizl_ID]=1 or [Aizl_ID]=3 or [Aizl_ID]=9),1,0))"
                        ...
                        " FROM dbo_stop WHERE (((dbo_stop.CKods) = 67891)) GROUP BY dbo_stop.CKods;"
                ...
                Begin Subform
                    ...
                    SourceObject ="Form.PE_LigumsViesnIstabinas_PASar_sub"
                    LinkChildFields ="Ligums"
                    LinkMasterFields ="Ligums"
                    Begin
                        Begin Label
                ...
                Begin Subform
                    ...
                    SourceObject ="Form.PE_LigumsViesnIstabinas_PASar_Samaksa_sub"
                    LinkChildFields ="Ligums"
                    LinkMasterFields ="Ligums"
                    Begin
                        Begin Label
